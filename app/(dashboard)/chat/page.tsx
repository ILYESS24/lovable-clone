  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        type: 'assistant',
        content: `Voici le code pour "${input}":\n\n\`\`\`jsx\nimport React from 'react';\n\nconst App = () => {\n  return (\n    <div className="min-h-screen bg-gray-100">\n      <h1 className="text-3xl font-bold text-center py-8">\n        Application générée par IA\n      </h1>\n    </div>\n  );\n};\n\nexport default App;\n\`\`\`\n\nCette application utilise React avec Tailwind CSS. Voulez-vous que je l'améliore ou ajoute des fonctionnalités spécifiques ?`,
        timestamp: new Date(),
        isCode: true,
        language: 'jsx',
        suggestions: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Prompts Rapides</CardTitle>
              </CardHeader>
